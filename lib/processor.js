...
TransactionProcessor.prototype.updateDerivationParams = function (address) {
  ...
  if (addressObject.derivationParams) {
    try {
      ...
      log.error({address: addressObject}, 'Address malformed. No derivation params present.');
      throw err;
    }
    ...
    log.debug('Single Address, no derivation params update needed.');
  }
};
